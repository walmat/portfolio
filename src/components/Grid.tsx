...
const Grid = ({ projects }: Props) => {
  ...
  const items: Item[] = useMemo(() => {
    return [
      ...
      {
        key: 'nebula',
        Component: projectMap['nebula'] ? (
          <ProjectCard project={projectMap['nebula']} />
        ) : null
      },
      {
        key: 'spotify',
      ...
      {
        key: 'tigerbob',
        Component: projectMap['tigerbob'] ? (
          <ProjectCard project={projectMap['tigerbob']} />
        ) : null
      },
      {
        key: 'blog',
      ...
      {
        key: 'recur',
        Component: projectMap['recur'] ? (
          <ProjectCard project={projectMap['recur']} />
        ) : null
      },
      {
        key: 'contact',
