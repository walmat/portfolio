...
export const lg: Layouts = {
  ...
  Media: [
    ...
    { i: "twitter", x: 3, y: 1, w: 1, h: 1 },
    { i: "nebula", x: 0, y: 2, w: 1, h: 2 },
    { i: "tigerbob", x: 1, y: 2, w: 1, h: 2 },
    { i: "spotify", x: 2, y: 2, w: 1, h: 1 },
    { i: "theme", x: 3, y: 2, w: 1, h: 1 },
...
export const md: Layouts = {
  ...
  Projects: [
    ...
    { i: "recur", x: 2, y: 0, w: 2, h: 1 },
    { i: "rainbow", x: 2, y: 1, w: 2, h: 1 },
  ...
  Media: [
    ...
    { i: "biography", x: 0, y: 2, w: 2, h: 2 },
    { i: "github", x: 2, y: 2, w: 1, h: 1 },
    { i: "twitter", x: 3, y: 2, w: 1, h: 1 },
    { i: "nebula", x: 2, y: 3, w: 1, h: 2 },
    { i: "tigerbob", x: 3, y: 3, w: 1, h: 2 },
...
export const mobile: Layouts = {
  ...
  About: [
    ...
    { i: "rainbow", x: 0, y: 7, w: 2, h: 1 },
    { i: "theme", x: 0, y: 8, w: 1, h: 1 },
    { i: "blog", x: 0, y: 9, w: 2, h: 2 },
    { i: "recur", x: 0, y: 11, w: 2, h: 1 },
    { i: "contact", x: 0, y: 12, w: 2, h: 2 },
  ],
  Projects: [
    { i: "nebula", x: 0, y: 0, w: 1, h: 2 },
    { i: "tigerbob", x: 1, y: 0, w: 1, h: 2 },
    { i: "rainbow", x: 0, y: 2, w: 2, h: 1 },
    { i: "recur", x: 0, y: 3, w: 2, h: 1 },
    { i: "theme", x: 0, y: 4, w: 1, h: 1 },
    { i: "biography", x: 0, y: 5, w: 2, h: 2 },
    { i: "github", x: 0, y: 7, w: 1, h: 1 },
    { i: "twitter", x: 1, y: 7, w: 1, h: 1 },
  ...
  Media: [
    ...
    { i: "github", x: 0, y: 6, w: 1, h: 1 },
    { i: "twitter", x: 1, y: 6, w: 1, h: 1 },
    { i: "spotify", x: 0, y: 7, w: 2, h: 2 },
    { i: "nebula", x: 0, y: 9, w: 1, h: 2 },
    { i: "tigerbob", x: 1, y: 9, w: 1, h: 2 },
